  ...
  return (
    <div className="relative flex-1">
      ...
      <input
        ...
        className="w-full bg-[#f4f8f5] border border-[#bce0cd] rounded-xl pl-10 pr-12 py-2.5 text-sm font-semibold text-[#0f291e] placeholder:text-[#4a6b5d] focus:outline-none focus:bg-white focus:ring-2 focus:ring-[#047857]/20 focus:border-[#047857] transition-all min-h-[44px] truncate"
      />
      {!localValue && (
